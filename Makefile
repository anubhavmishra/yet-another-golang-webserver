...
IMAGE_NAME := anubhavmishra/yet-another-golang-webserver
...
build-service: ## Build the main Go service
	...
	GOOS=linux GOARCH=amd64 go build -v -o ./build/linux/amd64/yet-another-golang-webserver .
...
run: ## Build and run the project
	mkdir -p ./build
	go build -o ./build/yet-another-golang-webserver && ./build/yet-another-golang-webserver